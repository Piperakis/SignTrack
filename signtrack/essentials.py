...
def extract_keypoints(results):
    """
    This is utilized to convert the keypoint results to a flat numpy array, that's easy to save and proccess
    """
...
def grammar_correct(sentence):
    ...
    Using this function, the sentence is corrected from common grammatical 
    errors
    """
    for key in phrases:
        if key in sentence:
